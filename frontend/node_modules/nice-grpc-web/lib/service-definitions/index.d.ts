import { FromGrpcWebServiceDefinition, GrpcWebServiceDefinition } from './grpc-web';
...
export type CompatServiceDefinition = ServiceDefinition | GrpcWebServiceDefinition | TsProtoServiceDefinition;
export type NormalizedServiceDefinition<Service extends CompatServiceDefinition> = Service extends ServiceDefinition ? Service : Service extends GrpcWebServiceDefinition ? FromGrpcWebServiceDefinition<Service> : Service extends TsProtoServiceDefinition ? FromTsProtoServiceDefinition<Service> : never;
