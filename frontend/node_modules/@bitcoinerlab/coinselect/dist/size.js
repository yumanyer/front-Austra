...
exports.size = exports.outputWeight = exports.inputWeight = void 0;
    ...
    if (expansion ? expansion.startsWith('pkh(') : isPKH) {
        ...
        const payment = bitcoinjs_lib_1.payments.p2sh({
            redeem: bitcoinjs_lib_1.payments.p2wsh({
                redeem: {
                    input: input.getScriptSatisfaction(signatures || 'DANGEROUSLY_USE_FAKE_SIGNATURES'),
...
signaturesPerInput) {
    ...
    inputs.forEach(function (input, index) {
        if (signaturesPerInput)
            ...
            totalWeight += inputWeight(input, isSegwitTx);
    });
