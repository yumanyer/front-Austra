 ...
 */
export declare function dustThreshold(
/**
 ...
 */
dustRelayFeeRate?: number): number;
export declare function isDust(output: OutputInstance, value: number, dustRelayFeeRate?: number): boolean;
