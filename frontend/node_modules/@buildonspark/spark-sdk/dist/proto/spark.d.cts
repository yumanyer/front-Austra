...
interface SenderTransferPackage_ReceiverIdentityPublicKeysEntry {
  key: string;
  value: Uint8Array;
}
/**
...
declare const HeartbeatEvent: MessageFns<HeartbeatEvent>;
...
declare const AddressedUtxo: MessageFns<AddressedUtxo>;
...
declare const SenderTransferPackage: MessageFns<SenderTransferPackage>;
declare const SenderTransferPackage_ReceiverIdentityPublicKeysEntry: MessageFns<SenderTransferPackage_ReceiverIdentityPublicKeysEntry>;
declare const StartTransferV3Request: MessageFns<StartTransferV3Request>;
...
declare const TransferReceiver: MessageFns<TransferReceiver>;
...
declare const GetUtxosForIdentityRequest: MessageFns<GetUtxosForIdentityRequest>;
declare const GetUtxosForIdentityResponse: MessageFns<GetUtxosForIdentityResponse>;
...
declare const SparkServiceDefinition: {
  ...
  readonly methods: {
    ...
    readonly start_transfer_v3: {
      ...
      readonly requestType: MessageFns<StartTransferV3Request>;
      readonly requestStream: false;
      readonly responseType: MessageFns<StartTransferResponse>;
      readonly responseStream: false;
      readonly options: {};
    ...
    readonly get_utxos_for_identity: {
      ...
      readonly requestType: MessageFns<GetUtxosForIdentityRequest>;
      readonly requestStream: false;
      readonly responseType: MessageFns<GetUtxosForIdentityResponse>;
      readonly responseStream: false;
      readonly options: {};
    };
...
interface SparkServiceImplementation<CallContextExt = {}> {
  ...
  start_transfer_v3(request: StartTransferV3Request, context: CallContext & CallContextExt): Promise<DeepPartial<StartTransferResponse>>;
  ...
  get_utxos_for_identity(request: GetUtxosForIdentityRequest, context: CallContext & CallContextExt): Promise<DeepPartial<GetUtxosForIdentityResponse>>;
...
interface SparkServiceClient<CallOptionsExt = {}> {
  ...
  start_transfer_v3(request: DeepPartial<StartTransferV3Request>, options?: CallOptions & CallOptionsExt): Promise<StartTransferResponse>;
  ...
  get_utxos_for_identity(request: DeepPartial<GetUtxosForIdentityRequest>, options?: CallOptions & CallOptionsExt): Promise<GetUtxosForIdentityResponse>;
