...
//#endregion
//#region src/graphql/objects/SparkWalletWebhookEventType.ts
var SparkWalletWebhookEventType = /* @__PURE__ */ function(SparkWalletWebhookEventType) {
	SparkWalletWebhookEventType["SPARK_LIGHTNING_RECEIVE_FINISHED"] = "SPARK_LIGHTNING_RECEIVE_FINISHED";
	SparkWalletWebhookEventType["SPARK_LIGHTNING_SEND_FINISHED"] = "SPARK_LIGHTNING_SEND_FINISHED";
	SparkWalletWebhookEventType["SPARK_COOP_EXIT_FINISHED"] = "SPARK_COOP_EXIT_FINISHED";
	SparkWalletWebhookEventType["SPARK_STATIC_DEPOSIT_FINISHED"] = "SPARK_STATIC_DEPOSIT_FINISHED";
	return SparkWalletWebhookEventType;
...
function mapTransferToWalletTransfer(proto, identityPublicKey, userRequest) {
	...
	return {
		...
		transferDirection: (() => {
			if (receiverIdentityPublicKey === identityPublicKey) return TransferDirection.INCOMING;
			if (proto.receivers.length > 0 && proto.receivers.some((r) => bytesToHex(r.identityPublicKey) === identityPublicKey)) return TransferDirection.INCOMING;
			return TransferDirection.OUTGOING;
		})(),
		userRequest,
		sparkInvoice: proto.sparkInvoice || void 0,
		receivers: proto.receivers.length > 0 ? proto.receivers.map((r) => ({
...
//#endregion
export { CoopExitFeeQuoteFromJson as A, BitcoinNetwork as B, LeavesSwapRequestFromJson as C, TransferFromJson as D, Transfer as E, getClaimStaticDepositQuery as F, CurrencyAmountFromJson as I, FRAGMENT$8 as L, getCoopExitFeeQuoteQuery as M, ClaimStaticDepositRequestType as N, SparkLeavesSwapRequestStatus as O, ClaimStaticDepositFromJson as P, CurrencyUnit$1 as R, FRAGMENT$4 as S, FRAGMENT$5 as T, LightningSendRequestStatus as _, mapTreeNodeToWalletLeaf as a, getLightningReceiveRequestQuery as b, SparkWalletUserToUserRequestsConnectionFromJson as c, SparkUserRequestType as d, SparkUserRequestStatus as f, getLightningSendRequestQuery as g, LightningSendRequestFromJson as h, mapTransferToWalletTransfer as i, FRAGMENT$6 as j, ExitSpeed as k, FRAGMENT$1 as l, FRAGMENT$2 as m, mapSettingsProtoToWalletSettings as n, SparkWalletWebhookEventType as o, SparkCoopExitRequestStatus as p, mapTransferLeafToWalletTransferLeaf as r, SparkWalletUser as s, TransferDirection as t, getUserRequestQuery as u, FRAGMENT$3 as v, getLeavesSwapRequestQuery as w, LightningReceiveRequestStatus as x, LightningReceiveRequestFromJson as y, ClaimStaticDepositStatus as z };