import { Logger, Query } from "@lightsparkdev/core";
...
//#endregion
//#region src/spark-readonly-client/spark-readonly-client.bare.d.ts
declare class SparkReadonlyClientBare extends SparkReadonlyClient {
  protected buildConnectionManager(config: WalletConfigService, authMode: AuthMode): ConnectionManagerBrowser;
}
//#endregion
export { type AggregateFrostBindingParams, type AggregateFrostParams, AuthenticationError, ConfigurationError, DefaultSparkSigner, type IKeyPackage, InternalValidationError, Network, NetworkError, type NetworkType, RPCError, type SignFrostBindingParams, type SignFrostParams, SparkAuthenticationError, SparkError, SparkErrorContextArg, SparkFrostBase, SparkReadonlyClientBare as SparkReadonlyClient, SparkRequestError, SparkSdkError, type SparkSigner, SparkValidationError, SparkWalletBare as SparkWallet, UnsafeStatelessSparkSigner, ValidationError, createLocalSigningOperators, decodeSparkAddress, getLatestDepositTxId, getLocalSigningOperators, getLocalSigningThreshold, getSparkFrost, getSspIdentityPublicKey, getSspSchemaEndpoint, mergeConfigOptionsForNetwork, normalizeNetworkType, rewriteSigningOperatorAddresses, setSparkFrostOnce };