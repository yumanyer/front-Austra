...
exports.deserializeTransaction = void 0;
...
const { TransferContract, WithdrawBalanceContract, WitnessCreateContract, FreezeBalanceV2Contract, UnfreezeBalanceV2Contract, CancelAllUnfreezeV2Contract, WithdrawExpireUnfreezeContract, DelegateResourceContract, UnDelegateResourceContract, FreezeBalanceContract, UnfreezeBalanceContract, } = globalThis.TronWebProto;
...
const { TriggerSmartContract, CreateSmartContract, UpdateSettingContract, UpdateEnergyLimitContract, ClearABIContract, } = globalThis.TronWebProto;
...
const { ProposalCreateContract, ProposalApproveContract, ProposalDeleteContract, } = globalThis.TronWebProto;
...
const DTransferContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(transferContract.getOwnerAddress_asU8()),
        to_address: (0, bytes_js_1.byteArray2hexStr)(transferContract.getToAddress_asU8()),
...
const DWithdrawBalanceContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(withdrawBalanceContract.getOwnerAddress_asU8()),
    };
    return commonData;
};
const DWitnessCreateContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(witnessCreateContract.getOwnerAddress_asU8()),
        url: (0, bytes_js_1.byteArray2hexStr)(witnessCreateContract.getUrl_asU8()),
    };
    return commonData;
};
const DTransferAssetContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(transferAssetContract.getOwnerAddress_asU8()),
        to_address: (0, bytes_js_1.byteArray2hexStr)(transferAssetContract.getToAddress_asU8()),
        asset_name: (0, bytes_js_1.byteArray2hexStr)(transferAssetContract.getAssetName_asU8()),
...
const DParticipateAssetIssueContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(participateAssetIssueContract.getOwnerAddress_asU8()),
        to_address: (0, bytes_js_1.byteArray2hexStr)(participateAssetIssueContract.getToAddress_asU8()),
        asset_name: (0, bytes_js_1.byteArray2hexStr)(participateAssetIssueContract.getAssetName_asU8()),
...
const DAssetIssueContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(assetIssueContract.getOwnerAddress_asU8()),
        name: (0, bytes_js_1.byteArray2hexStr)(assetIssueContract.getName_asU8()),
        abbr: (0, bytes_js_1.byteArray2hexStr)(assetIssueContract.getAbbr_asU8()),
        description: (0, bytes_js_1.byteArray2hexStr)(assetIssueContract.getDescription_asU8()),
        url: (0, bytes_js_1.byteArray2hexStr)(assetIssueContract.getUrl_asU8()),
...
const DUpdateAssetContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(updateAssetContract.getOwnerAddress_asU8()),
        description: (0, bytes_js_1.byteArray2hexStr)(updateAssetContract.getDescription_asU8()),
        url: (0, bytes_js_1.byteArray2hexStr)(updateAssetContract.getUrl_asU8()),
...
const deserializePermission = (permPb) => {
    ...
    return {
        ...
        operations: (0, bytes_js_1.byteArray2hexStr)(permPb.getOperations_asU8()),
        keys: permPb.getKeysList().map((keyPb) => ({
            address: (0, bytes_js_1.byteArray2hexStr)(keyPb.getAddress_asU8()),
...
const DAccountCreateContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(accountCreateContract.getOwnerAddress_asU8()),
        account_address: (0, bytes_js_1.byteArray2hexStr)(accountCreateContract.getAccountAddress_asU8()),
    };
    return commonData;
};
const DAccountUpdateContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(accountUpdateContract.getOwnerAddress_asU8()),
        account_name: (0, bytes_js_1.byteArray2hexStr)(accountUpdateContract.getAccountName_asU8()),
    };
    return commonData;
};
const DSetAccountIdContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(setAccountIdContract.getOwnerAddress_asU8()),
        account_id: (0, bytes_js_1.byteArray2hexStr)(setAccountIdContract.getAccountId_asU8()),
    };
    return commonData;
};
const DAccountPermissionUpdateContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(accountPermissionUpdateContract.getOwnerAddress_asU8()),
...
const DFreezeBalanceContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(freezeBalanceContract.getOwnerAddress_asU8()),
        ...
        receiver_address: (0, bytes_js_1.byteArray2hexStr)(freezeBalanceContract.getReceiverAddress_asU8()),
    };
    return commonData;
};
const DUnfreezeBalanceContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(unfreezeBalanceContract.getOwnerAddress_asU8()),
        resource: getResourceName(unfreezeBalanceContract.getResource()),
        receiver_address: (0, bytes_js_1.byteArray2hexStr)(unfreezeBalanceContract.getReceiverAddress_asU8()),
    };
    return commonData;
};
const DVoteWitnessContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(voteWitnessContract.getOwnerAddress_asU8()),
        votes: voteWitnessContract.getVotesList().map((votePb) => ({
            vote_address: (0, bytes_js_1.byteArray2hexStr)(votePb.getVoteAddress_asU8()),
...
const DProposalCreateContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(proposalCreateContract.getOwnerAddress_asU8()),
        parameters,
    };
    return commonData;
};
const DProposalApproveContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(proposalApproveContract.getOwnerAddress_asU8()),
...
const DProposalDeleteContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(proposalDeleteContract.getOwnerAddress_asU8()),
...
const DCreateSmartContract = (type, rawDataHex) => {
    ...
    const new_contract = newContractPb ? {
        origin_address: (0, bytes_js_1.byteArray2hexStr)(newContractPb.getOriginAddress_asU8()),
        abi: { entrys: abi },
        bytecode: (0, bytes_js_1.byteArray2hexStr)(newContractPb.getBytecode_asU8()),
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(createSmartContract.getOwnerAddress_asU8()),
...
const DUpdateSettingContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(updateSettingContract.getOwnerAddress_asU8()),
        contract_address: (0, bytes_js_1.byteArray2hexStr)(updateSettingContract.getContractAddress_asU8()),
...
const DUpdateEnergyLimitContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(updateEnergyLimitContract.getOwnerAddress_asU8()),
        contract_address: (0, bytes_js_1.byteArray2hexStr)(updateEnergyLimitContract.getContractAddress_asU8()),
...
const DClearABIContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(clearABIContract.getOwnerAddress_asU8()),
        contract_address: (0, bytes_js_1.byteArray2hexStr)(clearABIContract.getContractAddress_asU8()),
    };
    return commonData;
};
...
const DExchangeCreateContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(exchangeCreateContract.getOwnerAddress_asU8()),
        first_token_id: (0, bytes_js_1.byteArray2hexStr)(exchangeCreateContract.getFirstTokenId_asU8()),
        first_token_balance: exchangeCreateContract.getFirstTokenBalance(),
        second_token_id: (0, bytes_js_1.byteArray2hexStr)(exchangeCreateContract.getSecondTokenId_asU8()),
...
const DExchangeInjectContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(exchangeInjectContract.getOwnerAddress_asU8()),
        exchange_id: exchangeInjectContract.getExchangeId(),
        token_id: (0, bytes_js_1.byteArray2hexStr)(exchangeInjectContract.getTokenId_asU8()),
...
const DExchangeWithdrawContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(exchangeWithdrawContract.getOwnerAddress_asU8()),
        exchange_id: exchangeWithdrawContract.getExchangeId(),
        token_id: (0, bytes_js_1.byteArray2hexStr)(exchangeWithdrawContract.getTokenId_asU8()),
...
const DExchangeTransactionContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(exchangeTransactionContract.getOwnerAddress_asU8()),
        exchange_id: exchangeTransactionContract.getExchangeId(),
        token_id: (0, bytes_js_1.byteArray2hexStr)(exchangeTransactionContract.getTokenId_asU8()),
...
const DUpdateBrokerageContract = (type, rawDataHex) => {
    ...
    commonData.contract[0].parameter.value = {
        owner_address: (0, bytes_js_1.byteArray2hexStr)(updateBrokerageContract.getOwnerAddress_asU8()),
