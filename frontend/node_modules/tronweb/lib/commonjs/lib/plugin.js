            ...
            if (pluginInterface.fullClass) {
                ...
                for (const component in pluginInterface.components) {
                    if (PROTECTED_MODULES.includes(component)) {
                        console.warn(`[TronWeb] Plugin attempted to override protected module "${component}", which is not allowed. Plugin support will be removed in the next major version.`);
