export declare const story: {
    blockExplorers: {
        readonly default: {
            readonly name: "Data Network explorer";
            readonly url: "https://datanetscan.io";
            readonly apiUrl: "https://datanetscan.io/api/v2";
        };
    };
    ...
    rpcUrls: {
        readonly default: {
            readonly http: readonly ["https://mainnet.datarpc.io"];
        };
    };
