...
import { type KeyAuthorization, type SignatureEnvelope } from 'ox/tempo';
 ...
 */
export declare function prepareAuthorization<chain extends Chain | undefined, account extends Account | undefined>(client: Client<Transport, chain, account>, parameters: prepareAuthorization.Parameters<account>): Promise<prepareAuthorization.ReturnValue>;
export declare namespace prepareAuthorization {
    ...
    type ReturnValue = Compute<Omit<Parameters<Account | undefined>, 'account' | 'chainId'> & {
        account: Account;
        chainId: number;
        multisig: signKeyAuthorization.Parameters['multisig'];
...
export declare namespace signAuthorization {
    type Parameters<account extends Account | undefined = Account | undefined> = prepareAuthorization.Parameters<account> & {
