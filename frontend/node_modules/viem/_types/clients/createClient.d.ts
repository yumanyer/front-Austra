...
export type ClientConfig<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, accountOrAddress extends Account | Address | undefined = Account | Address | undefined, rpcSchema extends RpcSchema | undefined = undefined, tokens extends Tokens | undefined = Tokens | undefined> = {
...
type ExtendableProtectedActions<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined, tokens extends Tokens | undefined = Tokens | undefined> = Pick<PublicActions<transport, chain, account, tokens>, 'call' | 'createContractEventFilter' | 'createEventFilter' | 'estimateContractGas' | 'estimateGas' | 'getBlock' | 'getBlockNumber' | 'getChainId' | 'getContractEvents' | 'getEnsText' | 'getFilterChanges' | 'getGasPrice' | 'getLogs' | 'getTransaction' | 'getTransactionCount' | 'getTransactionReceipt' | 'prepareTransactionRequest' | 'readContract' | 'sendRawTransaction' | 'simulateContract' | 'uninstallFilter' | 'watchBlockNumber' | 'watchContractEvent'> & Pick<WalletActions<chain, account, tokens>, 'sendTransaction' | 'writeContract'>;
export type Client<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined, rpcSchema extends RpcSchema | undefined = undefined, extended extends Extended | undefined = Extended | undefined, tokens extends Tokens | undefined = Tokens | undefined> = Client_Base<transport, chain, account, rpcSchema, tokens> & (extended extends Extended ? extended : unknown) & {
    extend: <const client extends Extended & ExactPartial<ExtendableProtectedActions<transport, chain, account, tokens>>>(fn: (client: Client<transport, chain, account, rpcSchema, extended, tokens>) => client) => Client<transport, chain, account, rpcSchema, Prettify<client> & (extended extends Extended ? extended : unknown), tokens>;
};
type Client_Base<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined, rpcSchema extends RpcSchema | undefined = undefined, tokens extends Tokens | undefined = Tokens | undefined> = {
 ...
 * @internal
 */
export declare function bindActionDecorators(client: Client<Transport, Chain | undefined, any>, action: any): any;
/**
