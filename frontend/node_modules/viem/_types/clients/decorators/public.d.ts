...
import { type GetBlockReceiptsParameters, type GetBlockReceiptsReturnType } from '../../actions/public/getBlockReceipts.js';
...
import { type GetDelegationParameters, type GetDelegationReturnType } from '../../actions/public/getDelegation.js';
...
import { type WatchBlockHeadersParameters, type WatchBlockHeadersReturnType } from '../../actions/public/watchBlockHeaders.js';
...
export type PublicActions<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined, tokens extends Tokens | undefined = Tokens | undefined> = {
    /**
     ...
     * })
     */
    getBlockReceipts: (args?: GetBlockReceiptsParameters | undefined) => Promise<GetBlockReceiptsReturnType<chain>>;
    /**
     ...
     * })
     */
    watchBlockHeaders: (args: HasTransportType<transport, 'webSocket' | 'ipc'> extends true ? WatchBlockHeadersParameters<chain> : never) => WatchBlockHeadersReturnType;
    /**
    ...
    token: {
         ...
         * })
         */
        getAllowance: ((parameters: getAllowance.Parameters<chain, tokens>) => Promise<getAllowance.ReturnValue>) & {
            /**
             ...
             */
            call: (args: getAllowance.Args<chain, tokens>) => ReturnType<typeof getAllowance.call>;
        };
        /**
         ...
         * })
         */
        getBalance: ((parameters: getTokenBalance.Parameters<chain, account, tokens>) => Promise<getTokenBalance.ReturnValue>) & {
            /**
             ...
             * @returns The contract call.
             */
            call: (args: getTokenBalance.Args<chain, account, tokens>) => ReturnType<typeof getTokenBalance.call>;
        };
        /**
         ...
         */
        getMetadata: (parameters: getMetadata.Parameters<chain, tokens>) => Promise<getMetadata.ReturnValue>;
        /**
         ...
         */
        getTotalSupply: ((parameters: getTotalSupply.Parameters<chain, tokens>) => Promise<getTotalSupply.ReturnValue>) & {
            /**
             ...
             * @returns The contract call.
             */
            call: (args: getTotalSupply.Args<chain, tokens>) => ReturnType<typeof getTotalSupply.call>;
        };
    };
};
export declare function publicActions<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined, tokens extends Tokens | undefined = Tokens | undefined>(client: Client<transport, chain, account, undefined, undefined, tokens>): PublicActions<transport, chain, account, tokens>;
