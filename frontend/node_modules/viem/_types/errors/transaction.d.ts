...
import type { TransactionReceipt, TransactionType } from '../types/transaction.js';
...
export declare class FeePayerNonceMismatchError extends BaseError {
...
export declare class InvalidYParityError extends BaseError {
    constructor({ yParity }: {
        yParity: bigint;
    });
}
...
export type TransactionReceiptRevertedErrorType = TransactionReceiptRevertedError & {
    name: 'TransactionReceiptRevertedError';
};
export declare class TransactionReceiptRevertedError extends BaseError {
