...
export type SimulateCallsErrorType = AbiFunction.encodeData.ErrorType | AbiFunction.from.ErrorType | CallErrorType | GetBlockErrorType | GetBlockNumberErrorType | PadErrorType | SimulateBlocksErrorType | ErrorType;
/**
