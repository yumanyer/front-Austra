...
function formatTransactionRequest(r, action) {
    ...
    const { multisig: _multisig, multisigInit, multisigOwnerStates: _multisigOwnerStates, multisigSignatureCount, multisigVersion: _multisigVersion, signatures: _signatures, ...rpcRequest } = request;
