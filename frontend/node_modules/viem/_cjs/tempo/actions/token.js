...
(function (approve) {
    ...
    function call(...parameters) {
        const [client, args] = (0, utils_js_1.resolveCallParameters)(parameters);
...
async function readMetadataContracts(client, parameters) {
    ...
    const results = await Promise.allSettled(contracts.map((contract) => (0, readContract_js_1.readContract)(client, {
        ...rest,
        ...contract,
    })));
