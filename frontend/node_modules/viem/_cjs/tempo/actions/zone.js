...
(function (deposit) {
    function calls(args) {
        const { amount, chainId, memo = bytes_js_1.zeroHash, recipient, tempoRefundRecipient, token, zoneId, } = args;
...
(function (encryptedDeposit) {
    ...
    function calls(args) {
        const { amount, chainId, encrypted, keyIndex, tempoRefundRecipient, token, zoneId, } = args;
        const portalAddress = args.portalAddress ?? (0, zone_js_1.getPortalAddress)(chainId, zoneId);
        const tokenAddress = tempo_1.TokenId.toAddress(token);
