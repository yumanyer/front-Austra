...
async function prepareAuthorization(client, parameters) {
    ...
    const multisigState = await (async () => {
        ...
        const getState = (0, multisig_js_1.createMultisigStateResolver)((account) => multisig.getConfig(client, { account }));
        const states = await (0, multisig_js_1.getMultisigOwnerStates)(account, getState);
