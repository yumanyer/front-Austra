...
import { getKeyAuthorizationSignPayload, signKeyAuthorization, } from '../Account.js';
...
export async function prepareAuthorization(client, parameters) {
    ...
    const multisigState = await (async () => {
        ...
        const getState = createMultisigStateResolver((account) => multisig.getConfig(client, { account }));
        const states = await getMultisigOwnerStates(account, getState);
        const state = states[0];
        return { init: !state.initialized, states, version: state.version };
    })();
    const authorizationSignPayload = getKeyAuthorizationSignPayload(parsed, {
        ...parameters,
...
export async function signAuthorization(client, parameters) {
    const prepared = ('multisig' in parameters
        ? parameters
    ...
    return signKeyAuthorization(account_, {
        chainId: BigInt(chainId),
        key: accessKey,
        multisig: multisigState,
        ...rest,
