...
import { createMultisigStateResolver, getMultisigOwnerStates, } from './internal/multisig.js';
    ...
    prepareTransactionRequest: [
        async (r, { client, phase }) => {
            ...
            if (multisigIdentity) {
                ...
                const getState = createMultisigStateResolver((account) => getAction(client, multisig.getConfig, 'getConfig')({ account }));
                const ownerStates = request.account?.source === 'multisig'
                    ? getMultisigOwnerStates(request.account, getState)
                    : undefined;
