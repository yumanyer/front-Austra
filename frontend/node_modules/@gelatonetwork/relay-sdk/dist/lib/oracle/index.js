...
const getGelatoOracles = (config) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return (yield utils_1.axiosInstance.get(`${config.url}/oracles/`)).data.oracles;
    }
    catch (error) {
...
const getPaymentTokens = (payload, config) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return (yield utils_1.axiosInstance.get(`${config.url}/oracles/${payload.chainId.toString()}/paymentTokens/`)).data.paymentTokens;
    }
    catch (error) {
...
const getEstimatedFee = (payload, config) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const res = yield utils_1.axiosInstance.get(`${config.url}/oracles/${chainId.toString()}/estimate`, {
            params,
        });
