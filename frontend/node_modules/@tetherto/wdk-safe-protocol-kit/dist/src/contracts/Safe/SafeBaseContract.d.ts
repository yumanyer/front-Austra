 ...
 */
declare abstract class SafeBaseContract<SafeContractAbiType extends Abi> extends BaseContract<SafeContractAbiType> {
     ...
     */
    constructor(chainId: bigint, safeProvider: SafeProvider, defaultAbi: SafeContractAbiType, safeVersion: SafeVersion, isL1SafeSingleton?: boolean, customContractAddress?: string, customContractAbi?: SafeContractAbiType, deploymentType?: DeploymentType);
}
