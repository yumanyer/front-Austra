...
declare class SafeContract_v1_3_0 extends SafeBaseContract<SafeContract_v1_3_0_Abi> implements SafeContract_v1_3_0_Contract {
     ...
     */
    VERSION: SafeContract_v1_3_0_Function<'VERSION'>;
    /**
     * @param args - Array[owner, txHash]
     * @returns Array[approvedHashes]
     */
    approvedHashes: SafeContract_v1_3_0_Function<'approvedHashes'>;
    /**
     ...
     * @returns Empty array
     */
    checkNSignatures: SafeContract_v1_3_0_Function<'checkNSignatures'>;
    /**
     ...
     * @returns Empty array
     */
    checkSignatures: SafeContract_v1_3_0_Function<'checkSignatures'>;
    /**
     * @returns Array[domainSeparator]
     */
    domainSeparator: SafeContract_v1_3_0_Function<'domainSeparator'>;
    /**
     ...
     */
    encodeTransactionData: SafeContract_v1_3_0_Function<'encodeTransactionData'>;
    /**
     * Returns array of modules.
     * @param args - Array[start, pageSize]
     * @returns Array[Array[modules], next]
     */
    getModulesPaginated: SafeContract_v1_3_0_Function<'getModulesPaginated'>;
    /**
     * Returns the list of Safe owner accounts.
     * @returns Array[Array[owners]]
     */
    getOwners: SafeContract_v1_3_0_Function<'getOwners'>;
    /**
     * Reads `length` bytes of storage in the currents contract
     * @param args - Array[offset, length]
     * @returns Array[storage]
     */
    getStorageAt: SafeContract_v1_3_0_Function<'getStorageAt'>;
    /**
     * Returns the Safe threshold.
     * @returns Array[threshold]
     */
    getThreshold: SafeContract_v1_3_0_Function<'getThreshold'>;
    /**
     * Returns hash to be signed by owners.
     * @param args - Array[to, value, data, operation, safeTxGas, baseGas, gasPrice, gasToken, refundReceiver, _nonce]
     * @returns Array[transactionHash]
     */
    getTransactionHash: SafeContract_v1_3_0_Function<'getTransactionHash'>;
    /**
     * Checks if a specific Safe module is enabled for the current Safe.
     * @param args - Array[moduleAddress]
     * @returns Array[isEnabled]
     */
    isModuleEnabled: SafeContract_v1_3_0_Function<'isModuleEnabled'>;
    /**
     * Checks if a specific address is an owner of the current Safe.
     * @param args - Array[address]
     * @returns Array[isOwner]
     */
    isOwner: SafeContract_v1_3_0_Function<'isOwner'>;
    /**
     * Returns the Safe nonce.
     * @returns Array[nonce]
     */
    nonce: SafeContract_v1_3_0_Function<'nonce'>;
    /**
     * @param args - Array[messageHash]
     * @returns Array[signedMessages]
     */
    signedMessages: SafeContract_v1_3_0_Function<'signedMessages'>;
    /**
...
//# sourceMappingURL=SafeContract_v1_3_0.d.ts.map