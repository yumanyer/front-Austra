 ...
 */
export declare function zkSyncCreate2Address(from: string, safeVersion: SafeVersion, salt: Hex, input: Hex): string;
export declare function toTxResult(runner: ExternalClient, hash: Hash, options?: TransactionOptions): TransactionResult;
export declare function isEthersSigner(signer: any): signer is Client;
/**
