 ...
 */
declare abstract class MultiSendBaseContract<MultiSendContractAbiType extends Abi> extends BaseContract<MultiSendContractAbiType> {
     ...
     */
    constructor(chainId: bigint, safeProvider: SafeProvider, defaultAbi: MultiSendContractAbiType, safeVersion: SafeVersion, customContractAddress?: string, customContractAbi?: MultiSendContractAbiType, deploymentType?: DeploymentType);
}
