 ...
 */
declare abstract class MultiSendCallOnlyBaseContract<MultiSendCallOnlyContractAbiType extends Abi> extends BaseContract<MultiSendCallOnlyContractAbiType> {
     ...
     */
    constructor(chainId: bigint, safeProvider: SafeProvider, defaultAbi: MultiSendCallOnlyContractAbiType, safeVersion: SafeVersion, customContractAddress?: string, customContractAbi?: MultiSendCallOnlyContractAbiType, deploymentType?: DeploymentType);
}
export default MultiSendCallOnlyBaseContract;
//# sourceMappingURL=MultiSendCallOnlyBaseContract.d.ts.map