...
declare const safeContract_v1_3_0_AbiTypes: readonly [{
...
/**
 * Represents the function type derived by the given function name from the Safe contract version 1.3.0 ABI.
 *
 * @template ContractFunctionName - The function name, derived from the ABI.
 * @type {SafeContract_v1_3_0_Function}
 */
export type SafeContract_v1_3_0_Function<ContractFunctionName extends ExtractAbiFunctionNames<SafeContract_v1_3_0_Abi>> = ContractFunction<SafeContract_v1_3_0_Abi, ContractFunctionName>;
/**
