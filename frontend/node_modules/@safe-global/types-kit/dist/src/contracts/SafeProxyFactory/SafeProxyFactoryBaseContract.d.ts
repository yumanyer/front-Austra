 ...
 */
export type SafeProxyFactoryBaseContract<SafeProxyFactoryContractAbi extends Abi> = BaseContract<SafeProxyFactoryContractAbi> & {
    estimateGas: EstimateGasFunction<SafeProxyFactoryContractAbi>;
};
export default SafeProxyFactoryBaseContract;
//# sourceMappingURL=SafeProxyFactoryBaseContract.d.ts.map