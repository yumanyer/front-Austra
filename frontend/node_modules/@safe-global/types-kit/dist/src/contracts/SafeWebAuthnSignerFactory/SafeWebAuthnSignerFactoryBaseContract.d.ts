 ...
 */
export type SafeWebAuthnSignerFactoryBaseContract<SafeWebAuthnSignerFactoryContractAbi extends Abi> = BaseContract<SafeWebAuthnSignerFactoryContractAbi> & {
    estimateGas: EstimateGasFunction<SafeWebAuthnSignerFactoryContractAbi>;
};
export default SafeWebAuthnSignerFactoryBaseContract;
//# sourceMappingURL=SafeWebAuthnSignerFactoryBaseContract.d.ts.map