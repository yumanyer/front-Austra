...
exports.privArmor = exports.pubArmor = exports.Stream = exports.PubKeyPacket = exports.PacketLen = exports.oid = exports.opaquempi = exports.mpi = void 0;
...
const Hash = { ripemd160: legacy_1.ripemd160, sha256: sha2_1.sha256, sha512: sha2_1.sha512, sha3_256: sha3_1.sha3_256, sha1: legacy_1.sha1 };
...
function createPrivKey(pub, key, password, salt, iv, hash = 'sha1', count = 240, enc = 'aes128') {
    ...
    const secretClear = (0, utils_2.concatBytes)(keyBytes, (0, legacy_1.sha1)(keyBytes));
...
function getPublicPackets(edPriv, cvPriv, createdAt) {
    ...
    const fingerprint = base_1.hex.encode((0, legacy_1.sha1)(hashPubKey.encode({ pubKey: edPubPacket })));
...
function formatPublic(edPriv, cvPriv, user, createdAt) {
