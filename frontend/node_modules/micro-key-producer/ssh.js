...
exports.PrivateExport = exports.AuthData = exports.PublicKey = exports.SSHKeyType = exports.SSHBuf = exports.SSHString = void 0;
...
function getFingerprint(bytes) {
    ...
    return `SHA256:${base_1.base64.encode((0, sha2_1.sha256)(blob)).replace(/=$/, '')}`;
}
