...
const hash160 = (data) => (0, ripemd160_1.ripemd160)((0, sha2_1.sha256)(data));
...
class HDKey {
    ...
    static fromMasterSeed(seed) {
        ...
        const I = (0, hmac_1.hmac)(sha2_1.sha512, exports.MASTER_SECRET, seed);
        return new HDKey({
    ...
    constructor(opt) {
        ...
        (0, _assert_1.abytes)(opt.privateKey, 32);
        (0, _assert_1.abytes)(opt.chainCode, 32);
